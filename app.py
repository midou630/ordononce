...
def create_default_user():
    ...
    if not user:
        ...
        c.execute("""
        INSERT INTO users 
        (username, password, email, first_name, last_name, logo, first_login)
        VALUES (?, ?, ?, ?, ?, ?, ?)
        """,
        (
            "admin",
...
def register():
    ...
    if request.method == "POST":
        ...
        prescription_page = request.form.get("prescription_page")
        analysis_page = request.form.get("analysis_page")
        report_page = request.form.get("report_page")
